<!--
  ...
  Iteration: 2026-07-11 (v3) — badges reorganizados em subsessões,
    quote nova, LAOS como Flagship, multi-idioma PT/EN, contatos
    com badge + texto copiável. Inspirado na Opção C de layout.
-->
...
<p style="margin:4px 0 16px;font-size:0.82em;color:#b2bec3;">
...
<hr style="width:48px;margin:28px auto;border:none;border-top:2px solid #6c5ce7;opacity:0.3;"/>

> *"Technology is the way to materialize your dreams. AI is the shortcut."*
...
*Built with [LAOS](https://github.com/laurentaf/laos) — the system that builds systems.*

<svg width="20" height="20" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-top:8px;">
...
🔗 [linkedin.com/in/lauferreira](https://linkedin.com/in/lauferreira) · ✉️ laurentalp@hotmail.com
...
**Bibliotecas & Frameworks:** scikit-learn · xgboost · LightGBM · CatBoost · statsmodels · SHAP · LIME · Optuna · CrewAI · LangGraph

**Ferramentas & Plataformas:** Docker · Airflow · dbt · DuckDB · PostgreSQL · n8n · MS Fabric

**Visualização de Dados:** Power BI · HTML · CSS

**Cloud:** Azure · Render · Supabase · Databricks

**Provedores de IA:** OpenAI · Google Gemini · Anthropic Claude · NVIDIA NIM

**Padrões:** MCP Protocol

**Destaque:** 🔥 LAOS Ecosystem

---

> *"Tecnologia é o caminho para materializar seus sonhos. IA é o atalho."*

---

#### 🚀 Flagship: LAOS

Sistema operacional meta para IA composável. 7 módulos — 5 capacidades MCP independentes, motor de governança LACOUNCIL (14+ propostas aprovadas), e um orquestrador com roteamento determinístico.
...
<div align="center" style="margin:28px 0;opacity:0.35;font-size:0.85em;">

*Construído com [LAOS](https://github.com/laurentaf/laos) — o sistema que constrói sistemas.*
