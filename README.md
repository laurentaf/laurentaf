...
<p style="margin:8px 0 16px;">
  ...
  &nbsp;
  <a href="https://github.com/laurentaf?tab=repositories&q=nvidia"><img src="https://img.shields.io/badge/NVIDIA%20NIM-Inference-76B900?style=flat&logo=nvidia&logoColor=fff" alt="NVIDIA NIM"/></a>
  &nbsp;
...
| Area | Technologies |
|------|-------------|
| **Data Engineering** | Python · SQL (Oracle 19c, PostgreSQL, DuckDB, Azure SQL) · dbt · Databricks Lakehouse · MS Fabric |
| **AI / ML** | scikit-learn · xgboost · lightgbm · catboost · statsmodels · SHAP · LIME · optuna · MCP Protocol |
| **Multi-Agent** | CrewAI · NVIDIA NIM · n8n · OpenCode CLI · 11 specialized agents · 3 dispatch modes |
| **Cloud / BI** | Microsoft Azure · Databricks on Azure · Power BI · DuckDB (embedded OLAP) |
| **Langs** | Python (48.2%) · TypeScript (44.7%) · SQL · YAML · PowerShell · HTML/CSS |
...
| [**ShopAgent**](https://github.com/laurentaf/semana-ai-data-engineer) | Multi-agent shopping assistant · CrewAI + NVIDIA NIM | Local → cloud deployment |
...
| Area | Result |
|------|--------|
| LAOS velocity | 115 commits in 19 days · MIT licensed · active development |
